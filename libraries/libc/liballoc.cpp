...
extern "C" void *PREFIX(malloc)(size_t req_size) {
	int startedBet = 0;
	void *p = NULL;
	uintptr_t diff;
...
extern "C" void PREFIX(free)(void *ptr) {
    if (!ptr) {
        l_warningCount += 1;
        return;
    }
...
extern "C" void* PREFIX(calloc)(size_t nobj, size_t size) {
	size_t sz = nobj * size;
...
extern "C" void* PREFIX(realloc)(void* p, size_t size) {
